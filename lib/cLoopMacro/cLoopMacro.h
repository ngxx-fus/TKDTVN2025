...
/**
 * @brief Loop macro for iterating over a range using int.
 * @param i The loop variable.
 * @param a The starting value (inclusive).
 * @param b The ending value (exclusive).
 * @note Assumes int is defined elsewhere (e.g., in global.h).
 */
#ifndef REP
...
/**
 * @brief Reverse loop macro for iterating downward using int.
 * @param i The loop variable.
 * @param a The starting value (inclusive).
 * @param b The ending value (exclusive).
 * @note Assumes int is defined elsewhere (e.g., in global.h).
